...
def repo(tmp_path):
    ...
    conn.execute("CREATE TABLE chunks (chunk_id TEXT, artifact_id TEXT, is_active INTEGER, content_text TEXT, position_index INTEGER)")
    conn.execute("""
        CREATE TABLE insights (
            ...
            status_origin TEXT DEFAULT 'system',
            status_updated_at TIMESTAMP,
            previous_status TEXT,
            superseded_by_insight_id TEXT,
            status_comment TEXT,
...
def test_list_insights_filters_by_status(repo):
    ...
    """
    conn = repo._get_conn()
    conn.execute("INSERT INTO chunks VALUES ('c1', 'a1', 1, 'txt', 0)")
